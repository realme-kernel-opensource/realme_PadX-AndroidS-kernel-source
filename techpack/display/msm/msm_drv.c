...
static int __init msm_drm_register(void)
{
	...
	sde_wb_register();
#ifdef OPLUS_BUG_STABILITY
	if(is_project(21653) || is_project(21654) || is_project(21746) || is_project(0x2174A) || is_project(21707) || is_project(21708) || is_project(0x216E9) || is_project(0x216EA) || is_project(21629) || is_project(0x2162B) || is_project(21341) || is_project(21141) || is_project(21039)) {
		lcd_bias_init();
	}
#endif

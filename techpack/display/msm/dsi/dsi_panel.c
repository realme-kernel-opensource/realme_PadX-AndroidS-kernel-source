...
#endif
#ifdef OPLUS_BUG_STABILITY
	if(is_project(21707) || is_project(21708) || is_project(0x216E9) || is_project(0x216EA) || is_project(21629) || is_project(0x2162B) || is_project(21341) || is_project(21141)) {
...
#ifdef OPLUS_BUG_STABILITY
	if(is_project(21707) || is_project(21708) || is_project(0x216E9) || is_project(0x216EA) || is_project(21629) || is_project(0x2162B) || is_project(21341) || is_project(21141) || is_project(21039)) {
		if(!strcmp(panel->name,"dsjm ili7807s 21707 fhd plus mipi panel with DSC") || !strcmp(panel->name,"nt36672c video mode dsi fhd panel")) {
#ifdef OPLUS_FEATURE_TP_BASIC
			if((is_pd_with_guesture == false) || (1 == shutdown_flag) || panel_esd_check_failed) {
#endif
